...
ActiveRecord::Schema.define(version: 2021_04_01_080535) do
  ...
  create_table "address_books", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaser_id"], name: "index_address_books_on_purchaser_id"
  end
  ...
  add_foreign_key "address_books", "purchasers"
